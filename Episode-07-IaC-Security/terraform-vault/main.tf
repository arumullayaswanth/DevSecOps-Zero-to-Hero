...
resource "aws_s3_bucket" "replica" {
  ...
  bucket   = "${var.environment}-devsecops-vault-app-data-replica"
...
resource "aws_sns_topic" "replica_s3_events" {
  provider          = aws.replica
  name              = "${var.environment}-vault-replica-s3-event-notifications"
...
resource "aws_iam_role" "replication_role" {
  name = "${var.environment}-vault-s3-replication-role"
...
resource "aws_iam_role_policy" "replication_policy" {
  name = "${var.environment}-vault-s3-replication-policy"
